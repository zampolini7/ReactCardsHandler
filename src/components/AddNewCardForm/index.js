...
const validationForms = (valueOfForm) => {
  ...
  if (!valueOfForm.kindOfCreditCard.trim()) {
    ...
    valueOfForm.kindOfCreditCard.trim().toLowerCase() !== "credito" &&
    valueOfForm.kindOfCreditCard.trim().toLowerCase() !== "debito"
  ) {
  ...
  if (!valueOfForm.numberOfCreditCard.trim()) {
    ...
    !regexCounterOfDigits.test(valueOfForm.numberOfCreditCard.trim())
  ) {
  ...
  if (!valueOfForm.creditCard.trim()) {
    ...
    valueOfForm.creditCard.trim().toLowerCase() !== "mastercard" &&
    valueOfForm.creditCard.trim().toLowerCase() !== "visa" &&
    valueOfForm.creditCard.trim().toLowerCase() !== "naranja"
  ) {
    errors.creditCard =
      "*Solo se aceptan los valores: Mastercard, Visa o Naranja";
  }
  ...
  if (!valueOfForm.keyOfSecurity.trim()) {
    ...
    !regexCounterOfDigitsOfKey.test(valueOfForm.keyOfSecurity.trim())
  ) {
    ...
    <div className="container-form-add">
      <form onSubmit={handleSubmit} className="div-form-add">
        ...
        <input
          ...
          // required
        />
        {errors.kindOfCreditCard && (
          <p className="error-message"> {errors.kindOfCreditCard}</p>
        )}
        ...
        <input
          ...
          // required
        />
        {errors.numberOfCreditCard && (
          <p className="error-message">{errors.numberOfCreditCard} </p>
        )}
        ...
        />
        {errors.creditCard && (
          <p className="error-message"> {errors.creditCard} </p>
        )}
        ...
        <input
          ...
          // required
        />
        {errors.keyOfSecurity && (
          <p className="error-message"> {errors.keyOfSecurity} </p>
        )}
